...
import "../styles/MemberInformationSummaryPage.scss";

const MemberInformationSummaryPage = () => {
  return (
    <div className={cn("MemberInformationSummaryPage")}>
      <h1>ARO 개인정보 처리방침</h1>
      <div>
        ARO ('https://aurora-ARO.com/'이하 'ARO')은(는) 「개인정보 보호법」
        제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고
        원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을
        수립·공개합니다.
        <div>○ 이 개인정보처리방침은 2023년 7월 1일부터 적용됩니다.</div>
        <h2>제1조(개인정보의 처리 목적)</h2>
        <div>
          ('https://aurora-ARO.com/'이하 'ARO')은(는) 다음의 목적을 위하여
        ...
        <div>
          회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증 목적으로
          개인정보를 처리합니다.
        </div>
      </div>
      <h2>제2조(개인정보의 처리 및 보유 기간)</h2>
      <div>
        ① ARO은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <div>
        ① ARO 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        <li>1 [ 홈페이지 회원가입 및 관리 ]</li>
        <li>필수항목 : 로그인ID, 비밀번호, 이메일</li>
      </div>
      <h2>제4조(개인정보의 파기절차 및 파기방법)</h2>
      <div>
        ① ARO은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
      </div>
      <div>
        ② 개인정보 파기의 절차 및 방법은 다음과 같습니다.
        <div>1. 파기절차</div>
        ARO 은(는) 파기 사유가 발생한 개인정보를 선정하고, ARO 의 개인정보
      ...
      <div>
        ① 정보주체는 ARO 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구
        등의 권리를 행사할 수 있습니다.
      </div>
      <div>
        ② 제1항에 따른 권리 행사는ARO에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 ARO은(는) 이에 대해 지체 없이 조치하겠습니다.
      </div>
      <div>
      ...
      <div>
        ⑥ ARO은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를
        확인합니다.
      </div>
      <h2>제6조(개인정보의 안전성 확보조치에 관한 사항)</h2>
      <div>
        ARO은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
        있습니다.
      </div>
      ...
      <div>
        ARO('ARO')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
        막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터
      ...
      <div>
        ARO 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
        ‘쿠키(cookie)’를 사용하지 않습니다.
      </div>

      <h2>제8조(행태정보의 수집·이용·제공 및 거부 등에 관한 사항)</h2>

      <div>행태정보의 수집·이용·제공 및 거부등에 관한 사항</div>
      <div>
      ...
      <div>
        ARO 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보
        보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이
        개인정보를 추가적으로 이용·제공할 수 있습니다. 이에 따라 ARO 가(이)
      ...
      <div>
        ① ARO 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
      ...
      <li>성명 :송기훈</li>
      <li>직책 :개발자</li>
      <li>연락처 :01051752183, kihunbuzz@naver.com,</li>
      <div>
        ② 정보주체께서는 ARO 의 서비스(또는 사업)을 이용하시면서 발생한 모든
        개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
        보호책임자 및 담당부서로 문의하실 수 있습니다. ARO 은(는) 정보주체의
      ...
      <div>① 이 개인정보처리방침은 2023년 7월 1부터 적용됩니다.</div>
    </div>
  );
};

export default MemberInformationSummaryPage;
